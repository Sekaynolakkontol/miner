...
// Function to clear the console (Windows or Unix-based systems)
function clearConsole() {
    if (os.platform() === 'win32') {
        console.clear(); // On Windows, use `cls`
    } else {
        console.clear(); // On Unix-based systems (Linux, Mac), use `clear`
    }
}
...
async function printProgress(msg) {
    ...
    console.log('* Versions:   browserless-node-1.0.0');
